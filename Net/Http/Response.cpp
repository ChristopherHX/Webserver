...
void Response::EncodeHttp1(std::vector<uint8_t>::iterator & buffer)
{
...
void Response::EncodeHttp2(std::shared_ptr<V2::HPack::Encoder> & encoder, std::vector<uint8_t>::iterator &buffer)
{
