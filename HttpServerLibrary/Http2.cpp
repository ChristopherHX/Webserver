...
Stream & Http2::Server::GetStream(std::vector<Stream> &streams, std::shared_mutex &streamsmtx, uint32_t streamIndentifier)
{
	while (true)
	{
...
void Http2::Server::filehandler(RequestContext &rcontext)
{
